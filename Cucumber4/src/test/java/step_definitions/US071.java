...
public class US071 {
    ...
    @Then("kullanici aldigi cevabin durum kodunun {int} oldugunu dogrular")
    public void kullaniciAldigiCevabinDurumKodununOldugunuDogrular(int durumKodu) {
    ...
    public void kullaniciGelenCevapIcerisindekiSonucOzelligininDegerininTrueOldugunuDogrular() {
